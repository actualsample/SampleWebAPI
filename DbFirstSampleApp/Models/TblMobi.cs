...
namespace DbFirstSampleApp.Models
{
    ...
    public partial class TblMobi
    {
        ...
        [Column("ket_agen")]
        public string? KetAgen { get; set; }
        [Column("email")]
        [StringLength(500)]
        [Unicode(false)]
        public string? Email { get; set; }
        [Column("flag_pending_tgl")]
        public int FlagPendingTgl { get; set; }
        [Column("flag_proses_photo")]
        public int FlagProsesPhoto { get; set; }
        [Column("lampiran_spk")]
        [Unicode(false)]
